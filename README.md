# 隔壁同樂室 Neighbor Family Games

一個可直接執行的家庭遊戲平台，目前包含十五款棋類、牌類與街機遊戲：

- 十五款遊戲各自獨立的房間大廳與在線玩家名單
- 一對一邀請、接受／婉拒與跨分頁即時對局
- 五子棋單人與雙人模式皆採用 19×19 棋盤
- 中國象棋支援完整棋子走法、將帥照面、將軍判定與吃將勝負
- 兩款遊戲皆提供單人、線上雙人，以及初級、進階、困難三級 AI
- 五子棋單人 AI 採用 Rapfi WebAssembly 與官方 Mix9sVQ 神經網路：初級搜尋 4 秒、進階 8 秒、困難全力搜尋 15 秒
- 中國象棋 AI 採用背景 Worker、迭代加深與 Alpha-Beta 剪枝，三級難度分別搜尋 2／3／4 層
- 黑白棋採 8×8 夾子翻面規則，AI 會評估角落、位置權重與行動力
- 中國跳棋支援 2～3 人、相鄰移動、跨子連續跳躍與 AI 補位
- 麻將使用 136 張牌的家庭自摸版，可選 1～4 位玩家，空位由 AI 補上
- 大老二支援 3～5 人、單張／對子／三條／五張牌型，空位由 AI 補上
- 暗棋支援翻棋、炮隔子吃棋、兵將特殊吃法與 AI 對戰
- 西洋棋支援將軍／將死、王車易位、吃過路兵與升變
- 圍棋使用 13 路棋盤，支援提子、自殺禁手、簡單劫與中國面積計分
- 二十一點、撿紅點與九九皆支援 3～5 人桌，其餘座位由 AI 補齊
- 俄羅斯方塊提供四段速度、方向鍵／空白鍵操作、手機觸控按鈕，以及同步顯示對手棋盤與分數的雙人分屏房
- 麻將使用完整萬、筒、索、風牌與三元牌圖樣；暗棋未翻面時顯示雙環棋背紋路
- 皮卡丘排球支援沙灘排球物理、AI、本機雙人與房間連線雙人，先得 7 分獲勝
- 賽車障礙支援 AI、本機雙人與房間連線雙人，包含三角錐、油漬、路障、耐久與里程計分
- 十五款遊戲各自擁有獨立房間大廳，可建立、篩選與加入房間
- Rapfi 在背景 Worker 執行；WASM 不支援或載入失敗時自動切換原生 JavaScript AI
- 單人模式不限思考時間，可選擇先手或後手，以及回到上一步、重新開始
- 三戰兩勝／五戰三勝系列賽、局末續戰確認與每局交換先後手
- 線上邀請者可決定第一局先手或後手，棋局快照具版本防倒退保護
- 線上對戰內建即時聊天室，訊息隨棋局同步
- 線上邀請可設定每步 1／3／5／10 分鐘，逾時由伺服器從空位隨機代下
